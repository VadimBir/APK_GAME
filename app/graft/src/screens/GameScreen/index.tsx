...
import { buildGameStack, type GameStack } from '../../game/wiring.ts';
import type { StoryBible, TurnOutput } from '../../game/StoryEngine.ts';
import { PRICE_DISPLAY } from '../../core/billing/entitlement.ts';
import type { DiffusionError } from '../../core/diffusion/errors.ts';
...
export default function GameScreen({ bible, modelStore, selectedLlmId, docDir }: Props) {
